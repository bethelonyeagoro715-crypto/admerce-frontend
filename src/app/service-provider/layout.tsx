    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
      ...
      {hasSetup !== false && (
        <div style={styles.navBar}>
          ...
          <NavItem Icon={MdCalendarToday} label="Bookings" active={currentIndex === 1} onTap={() => navigate(1)} />
          <NavItem Icon={MdAttachMoney} label="Earnings" active={currentIndex === 2} onTap={() => navigate(2)} />
